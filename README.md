...
# Enable explicit orphan interface cleanup (RedHat family only)
interfaces_cleanup_orphan: false

# Interfaces to exclude from cleanup
interfaces_cleanup_exclude: []

# Interfaces to remove from config files and from kernel links.
# This list is generated by the role when cleanup is enabled.
interfaces_cleanup_interfaces: []
```
